...
public class LukeManager : IManager
{
    public void Update(GameData gameData)
    {
        ...
        gameData.LukeData.ChangeBounds(new Rectangle((int)gameData.LukeData.Position.X,
    ...
    public void Init(GameData gameData, HeroUpdate hero)
    {
        ...
        gameData.LukeData.ChangePosition(new Vector2(gameData.Width / 2, gameData.Height / 2));
    }
